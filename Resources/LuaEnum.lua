...
LE_CHARACTER_UNDELETE_RESULT_ERROR_DEATHKNIGHT_LEVEL_REQUIREMENT = 7
LE_CHARACTER_UNDELETE_RESULT_ERROR_UNKNOWN = 8
...
NUM_LE_INVITE_CONFIRMATION_RELATIONS = 4
