Enum = {
	...
	HousingResult = {
		...
		MaxPreviewDecorReached = 66,
		MaxStorageDecorReached = 67,
		MissingCoreFixture = 68,
		MissingDye = 69,
		MissingExpansionAccess = 70,
		MissingFactionMap = 71,
		MissingPrivateNeighborhoodInvite = 72,
		MoreHouseSlotsNeeded = 73,
		MoreSignaturesNeeded = 74,
		NeighborhoodNotFound = 75,
		NoNeighborhoodOwnershipRequests = 76,
		NotInDecorEditMode = 77,
		NotInFixtureEditMode = 78,
		NotInLayoutEditMode = 79,
		NotInsideHouse = 80,
		NotOnOwnedPlot = 81,
		OperationAborted = 82,
		OwnerNotInGuild = 83,
		PermissionDenied = 84,
		PlacementTargetInvalid = 85,
		PlayerNotFound = 86,
		PlayerNotInInstance = 87,
		PlotNotFound = 88,
		PlotNotVacant = 89,
		PlotReservationCooldown = 90,
		PlotReserved = 91,
		RoomNotFound = 92,
		RoomPlacementOutOfBounds = 93,
		RoomUpdateFailed = 94,
		RpcFailure = 95,
		ServiceNotAvailable = 96,
		StaticDataNotFound = 97,
		TimeoutLimit = 98,
		TimerunningNotAllowed = 99,
		TokenRequired = 100,
		TooManyRequests = 101,
		TransactionFailure = 102,
		UncollectedExteriorFixture = 103,
		UncollectedHouseType = 104,
		UncollectedRoom = 105,
		UncollectedRoomMaterial = 106,
		UncollectedRoomTheme = 107,
		UnlockOperationFailed = 108,
	},
