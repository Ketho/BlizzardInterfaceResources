Enum = {
	...
	HousingResult = {
		...
		BlueprintStorageLimit = 10,
		BlueprintVersionInvalid = 11,
		BoundsFailureChildren = 12,
		BoundsFailurePlot = 13,
		BoundsFailureRoom = 14,
		BoundToStartingArea = 15,
		CannotAfford = 16,
		CharterComplete = 17,
		CollisionInvalid = 18,
		DbError = 19,
		DecorCannotBeRedeemed = 20,
		DecorItemNotDestroyable = 21,
		DecorNotFound = 22,
		DecorNotFoundInStorage = 23,
		DuplicateCharterSignature = 24,
		FilterRejected = 25,
		FixtureCantDeleteDoor = 26,
		FixtureHookEmpty = 27,
		FixtureHookOccupied = 28,
		FixtureHouseTypeMismatch = 29,
		FixtureNotFound = 30,
		FixtureSizeMismatch = 31,
		FixtureTypeMismatch = 32,
		GenericFailure = 33,
		GuildMoreAccountsNeeded = 34,
		GuildMoreActivePlayersNeeded = 35,
		GuildNotLoaded = 36,
		HouseEditLockFailed = 37,
		HouseExteriorAlreadyThatSize = 38,
		HouseExteriorAlreadyThatType = 39,
		HouseExteriorRootNotFound = 40,
		HouseExteriorTypeNeighborhoodMismatch = 41,
		HouseExteriorTypeNotFound = 42,
		HouseExteriorTypeSizeMismatch = 43,
		HouseExteriorSizeNotAvailable = 44,
		HookNotChildOfFixture = 45,
		HouseNotFound = 46,
		IncorrectFaction = 47,
		InvalidDecorItem = 48,
		InvalidDistance = 49,
		InvalidExteriorDocument = 50,
		InvalidGuild = 51,
		InvalidHouse = 52,
		InvalidInstance = 53,
		InvalidInteraction = 54,
		InvalidInteriorDocument = 55,
		InvalidLightOverlap = 56,
		InvalidMap = 57,
		InvalidNeighborhoodName = 58,
		InvalidRoomLayout = 59,
		InsufficientRoomBudget = 60,
		LockedByOtherPlayer = 61,
		LockOperationFailed = 62,
		MaxDecorReached = 63,
		MaxPreviewDecorReached = 64,
		MissingCoreFixture = 65,
		MissingDye = 66,
		MissingExpansionAccess = 67,
		MissingFactionMap = 68,
		MissingPrivateNeighborhoodInvite = 69,
		MoreHouseSlotsNeeded = 70,
		MoreSignaturesNeeded = 71,
		NeighborhoodNotFound = 72,
		NoNeighborhoodOwnershipRequests = 73,
		NotInDecorEditMode = 74,
		NotInFixtureEditMode = 75,
		NotInLayoutEditMode = 76,
		NotInsideHouse = 77,
		NotOnOwnedPlot = 78,
		OperationAborted = 79,
		OwnerNotInGuild = 80,
		PermissionDenied = 81,
		PlacementTargetInvalid = 82,
		PlayerNotFound = 83,
		PlayerNotInInstance = 84,
		PlotNotFound = 85,
		PlotNotVacant = 86,
		PlotReservationCooldown = 87,
		PlotReserved = 88,
		RoomNotFound = 89,
		RoomPlacementOutOfBounds = 90,
		RoomUpdateFailed = 91,
		RpcFailure = 92,
		ServiceNotAvailable = 93,
		StaticDataNotFound = 94,
		TimeoutLimit = 95,
		TimerunningNotAllowed = 96,
		TokenRequired = 97,
		TooManyRequests = 98,
		TransactionFailure = 99,
		UncollectedExteriorFixture = 100,
		UncollectedHouseType = 101,
		UncollectedRoom = 102,
		UncollectedRoomMaterial = 103,
		UncollectedRoomTheme = 104,
		UnlockOperationFailed = 105,
	},
