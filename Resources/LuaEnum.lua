Enum = {
	...
	AccountStateLoadedFlags = {
		...
		AccountStateHousingDataLoaded = "0x0000080000000000",
		AccountStateWarbandScenesLoaded = "0x0000100000000000",
		AccountStateEventRecordsLoaded = "0x0000200000000000",
	},
	...
	CreateAllAccountData = {
		...
		CreateAllAccountStateHousingData = "0x0000080000000000",
		CreateAllWarbandScenesLoadedDone = "0x0000100000000000",
		CreateAllEventRecordsDone = "0x0000200000000000",
	},
	...
	HousingCatalogEntrySubtype = {
		...
		Unowned = 1,
		MarketItem = 2,
		OwnedModifiedStack = 3,
		OwnedUnmodifiedStack = 4,
	},
	...
	HousingResult = {
		...
		GenericFailure = 20,
		GuildNotLoaded = 21,
		HouseEditLockFailed = 22,
		HouseExteriorRootNotFound = 23,
		HookNotChildOfFixture = 24,
		HouseNotFound = 25,
		IncorrectFaction = 26,
		InvalidDecorItem = 27,
		InvalidDistance = 28,
		...
		InvalidHouse = 30,
		InvalidInstance = 31,
		InvalidInteraction = 32,
		InvalidMap = 33,
		InvalidNeighborhoodName = 34,
		InvalidRoomLayout = 35,
		LockedByOtherPlayer = 36,
		LockOperationFailed = 37,
		MaxDecorReached = 38,
		MissingCoreFixture = 39,
		MissingDye = 40,
		MissingExpansionAccess = 41,
		MissingFactionMap = 42,
		MissingPrivateNeighborhoodInvite = 43,
		MissingTheme = 44,
		MoreHouseSlotsNeeded = 45,
		MoreSignaturesNeeded = 46,
		NeighborhoodNotFound = 47,
		NotInDecorEditMode = 48,
		NoNeighborhoodOwnershipRequests = 49,
		NotInFixtureEditMode = 50,
		NotInLayoutEditMode = 51,
		NotInsideHouse = 52,
		NotOnOwnedPlot = 53,
		OperationAborted = 54,
		PermissionDenied = 55,
		PlacementTargetInvalid = 56,
		PlayerNotFound = 57,
		PlayerNotInInstance = 58,
		PlotNotFound = 59,
		PlotNotVacant = 60,
		PlotReservationCooldown = 61,
		PlotReserved = 62,
		RoomNotFound = 63,
		RoomUpdateFailed = 64,
		RpcFailure = 65,
		ServiceNotAvailable = 66,
		StaticDataNotFound = 67,
		TimeoutLimit = 68,
		TimerunningNotAllowed = 69,
		TokenRequired = 70,
		TooManyRequests = 71,
		TransactionFailure = 72,
		UnlockOperationFailed = 73,
	},
	...
	ItemCollectionType = {
		...
		ItemCollectionRoomTheme = 10,
		ItemCollectionRoomMaterial = 11,
	...
	NeighbordhoodInitiativeCategory = {
		Current = 0,
		Legacy = 1,
	},
	NeighborhoodFlags = {
...
Constants = {
	...
	HousingCatalogConsts = {
		HOUSING_CATALOG_NONE_TAG_ID = -33,
		HOUSING_CATALOG_SIZE_DATAGROUP_ID = 2,
		HOUSING_CATALOG_ENTRY_TAGS_EXPECTED = 5,
		HOUSING_CATALOG_NUM_FEATURED_BUNDLES_EXPECTED = 5,
		HOUSING_CATALOG_SUBCATEGORIES_PER_CATEGORY_EXPECTED = 5,
		HOUSING_CATALOG_NUM_FILTER_TAG_GROUPS = 6,
		HOUSING_CATALOG_ROOMS_CATEGORY_ID = 9,
		HOUSING_CATALOG_TAG_GROUP_TAGS_EXPECTED = 16,
		HOUSING_CATALOG_FEATURED_CATEGORY_ID = 17,
		HOUSING_CATALOG_ALL_CATEGORY_ID = 18,
		HOUSING_CATALOG_CATEGORIES_EXPECTED = 20,
		HOUSING_CATALOG_OPTIONS_PER_SUBCATEGORY_EXPECTED = 24,
		HOUSING_CATALOG_ROOMS_SUBCATEGORY_ID = 35,
		HOUSING_CATALOG_SUBCATEGORIES_EXPECTED = 50,
		HOUSING_CATALOG_OPTIONS_PER_CATEGORY_EXPECTED = 60,
		HOUSING_CATALOG_FILTER_TAGS_EXPECTED = 90,
		HOUSING_CATALOG_NUM_FEATURED_EXPECTED = 100,
		HOUSING_CATALOG_OPTIONS_EXPECTED = 1200,
