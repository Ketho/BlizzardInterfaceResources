Enum = {
	...
	HousingResult = {
		...
		BlueprintNotFound = 9,
		BlueprintTypeInvalid = 10,
		BlueprintRequirementsUnmet = 11,
		BlueprintRoomPlacementRequired = 12,
		BlueprintStorageLimit = 13,
		BlueprintVersionInvalid = 14,
		BoundsFailureChildren = 15,
		BoundsFailurePlot = 16,
		BoundsFailureRoom = 17,
		BoundToStartingArea = 18,
		CannotAfford = 19,
		CharterComplete = 20,
		CollisionInvalid = 21,
		DbError = 22,
		DecorCannotBeRedeemed = 23,
		DecorItemNotDestroyable = 24,
		DecorNotFound = 25,
		DecorNotFoundInStorage = 26,
		DuplicateCharterSignature = 27,
		FilterRejected = 28,
		FixtureCantDeleteDoor = 29,
		FixtureHookEmpty = 30,
		FixtureHookOccupied = 31,
		FixtureHouseTypeMismatch = 32,
		FixtureNotFound = 33,
		FixtureSizeMismatch = 34,
		FixtureTypeMismatch = 35,
		GenericFailure = 36,
		GuildMoreAccountsNeeded = 37,
		GuildMoreActivePlayersNeeded = 38,
		GuildNotLoaded = 39,
		HouseEditLockFailed = 40,
		HouseExteriorAlreadyThatSize = 41,
		HouseExteriorAlreadyThatType = 42,
		HouseExteriorRootNotFound = 43,
		HouseExteriorTypeNeighborhoodMismatch = 44,
		HouseExteriorTypeNotFound = 45,
		HouseExteriorTypeSizeMismatch = 46,
		HouseExteriorSizeNotAvailable = 47,
		HookNotChildOfFixture = 48,
		HouseNotFound = 49,
		IncorrectFaction = 50,
		InvalidDecorItem = 51,
		InvalidDistance = 52,
		InvalidExteriorDocument = 53,
		InvalidGuild = 54,
		InvalidHouse = 55,
		InvalidInstance = 56,
		InvalidInteraction = 57,
		InvalidInteriorDocument = 58,
		InvalidLightOverlap = 59,
		InvalidMap = 60,
		InvalidNeighborhoodName = 61,
		InvalidRoomLayout = 62,
		InsufficientRoomBudget = 63,
		LockedByOtherPlayer = 64,
		LockOperationFailed = 65,
		MaxPlacedDecorReached = 66,
		MaxPetDecorReached = 67,
		MaxPreviewDecorReached = 68,
		MaxStorageDecorReached = 69,
		MissingCoreFixture = 70,
		MissingDye = 71,
		MissingExpansionAccess = 72,
		MissingFactionMap = 73,
		MissingPrivateNeighborhoodInvite = 74,
		MoreHouseSlotsNeeded = 75,
		MoreSignaturesNeeded = 76,
		NeighborhoodNotFound = 77,
		NoNeighborhoodOwnershipRequests = 78,
		NotInDecorEditMode = 79,
		NotInFixtureEditMode = 80,
		NotInLayoutEditMode = 81,
		NotInsideHouse = 82,
		NotOnOwnedPlot = 83,
		OperationAborted = 84,
		OwnerNotInGuild = 85,
		PermissionDenied = 86,
		PlacementTargetInvalid = 87,
		PlayerNotFound = 88,
		PlayerNotInInstance = 89,
		PlotNotFound = 90,
		PlotNotVacant = 91,
		PlotReservationCooldown = 92,
		PlotReserved = 93,
		RoomNotFound = 94,
		RoomPlacementOutOfBounds = 95,
		RoomUpdateFailed = 96,
		RpcFailure = 97,
		ServiceNotAvailable = 98,
		StaticDataNotFound = 99,
		TimeoutLimit = 100,
		TimerunningNotAllowed = 101,
		TokenRequired = 102,
		TooManyRequests = 103,
		TransactionFailure = 104,
		UncollectedExteriorFixture = 105,
		UncollectedHouseType = 106,
		UncollectedRoom = 107,
		UncollectedRoomMaterial = 108,
		UncollectedRoomTheme = 109,
		UnlockOperationFailed = 110,
	},
