...
Constants = {
	...
	ITEM_WEAPON_SUBCLASSConstants_PreMists = {
		ITEM_WEAPON_SUBCLASS_ISTITANSGRIPWEAPON_MASK = 290,
	},
...
NUM_LE_INVITE_CONFIRMATION_RELATIONS = 5
...
LE_INVITE_CONFIRMATION_RELATION_RECENT_ALLIES = 4
