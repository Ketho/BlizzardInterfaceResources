Enum = {
	...
	HousingResult = {
		...
		BlueprintCodeInvalid = 2,
		BlueprintGenericExportError = 3,
		BlueprintGenericImportError = 4,
		BlueprintLocationInvalid = 5,
		BlueprintNameInvalid = 6,
		BlueprintNotFound = 7,
		BlueprintTypeInvalid = 8,
		BlueprintRequirementsUnmet = 9,
		BlueprintRoomPlacementRequired = 10,
		BlueprintStorageLimit = 11,
		BlueprintVersionInvalid = 12,
		BoundsFailureChildren = 13,
		BoundsFailurePlot = 14,
		BoundsFailureRoom = 15,
		BoundToStartingArea = 16,
		CannotAfford = 17,
		CharterComplete = 18,
		CollisionInvalid = 19,
		DbError = 20,
		DecorCannotBeRedeemed = 21,
		DecorItemNotDestroyable = 22,
		DecorNotFound = 23,
		DecorNotFoundInStorage = 24,
		DuplicateCharterSignature = 25,
		FilterRejected = 26,
		FixtureCantDeleteDoor = 27,
		FixtureHookEmpty = 28,
		FixtureHookOccupied = 29,
		FixtureHouseTypeMismatch = 30,
		FixtureNotFound = 31,
		FixtureSizeMismatch = 32,
		FixtureTypeMismatch = 33,
		GenericFailure = 34,
		GuildMoreAccountsNeeded = 35,
		GuildMoreActivePlayersNeeded = 36,
		GuildNotLoaded = 37,
		HouseEditLockFailed = 38,
		HouseExteriorAlreadyThatSize = 39,
		HouseExteriorAlreadyThatType = 40,
		HouseExteriorRootNotFound = 41,
		HouseExteriorTypeNeighborhoodMismatch = 42,
		HouseExteriorTypeNotFound = 43,
		HouseExteriorTypeSizeMismatch = 44,
		HouseExteriorSizeNotAvailable = 45,
		HookNotChildOfFixture = 46,
		HouseNotFound = 47,
		IncorrectFaction = 48,
		InvalidDecorItem = 49,
		InvalidDistance = 50,
		InvalidExteriorDocument = 51,
		InvalidGuild = 52,
		InvalidHouse = 53,
		InvalidInstance = 54,
		InvalidInteraction = 55,
		InvalidInteriorDocument = 56,
		InvalidLightOverlap = 57,
		InvalidMap = 58,
		InvalidNeighborhoodName = 59,
		InvalidRoomLayout = 60,
		InsufficientRoomBudget = 61,
		LockedByOtherPlayer = 62,
		LockOperationFailed = 63,
		MaxDecorReached = 64,
		MaxPreviewDecorReached = 65,
		MissingCoreFixture = 66,
		MissingDye = 67,
		MissingExpansionAccess = 68,
		MissingFactionMap = 69,
		MissingPrivateNeighborhoodInvite = 70,
		MoreHouseSlotsNeeded = 71,
		MoreSignaturesNeeded = 72,
		NeighborhoodNotFound = 73,
		NoNeighborhoodOwnershipRequests = 74,
		NotInDecorEditMode = 75,
		NotInFixtureEditMode = 76,
		NotInLayoutEditMode = 77,
		NotInsideHouse = 78,
		NotOnOwnedPlot = 79,
		OperationAborted = 80,
		OwnerNotInGuild = 81,
		PermissionDenied = 82,
		PlacementTargetInvalid = 83,
		PlayerNotFound = 84,
		PlayerNotInInstance = 85,
		PlotNotFound = 86,
		PlotNotVacant = 87,
		PlotReservationCooldown = 88,
		PlotReserved = 89,
		RoomNotFound = 90,
		RoomPlacementOutOfBounds = 91,
		RoomUpdateFailed = 92,
		RpcFailure = 93,
		ServiceNotAvailable = 94,
		StaticDataNotFound = 95,
		TimeoutLimit = 96,
		TimerunningNotAllowed = 97,
		TokenRequired = 98,
		TooManyRequests = 99,
		TransactionFailure = 100,
		UncollectedExteriorFixture = 101,
		UncollectedHouseType = 102,
		UncollectedRoom = 103,
		UncollectedRoomMaterial = 104,
		UncollectedRoomTheme = 105,
		UnlockOperationFailed = 106,
	},
