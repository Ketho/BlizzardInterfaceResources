Enum = {
	...
	HousingResult = {
		...
		BlueprintGenericExportError = 4,
		BlueprintGenericImportError = 5,
		BlueprintLocationInvalid = 6,
		BlueprintNameInvalid = 7,
		BlueprintNotFound = 8,
		BlueprintTypeInvalid = 9,
		BlueprintRequirementsUnmet = 10,
		BlueprintRoomPlacementRequired = 11,
		BlueprintStorageLimit = 12,
		BlueprintVersionInvalid = 13,
		BoundsFailureChildren = 14,
		BoundsFailurePlot = 15,
		BoundsFailureRoom = 16,
		BoundToStartingArea = 17,
		CannotAfford = 18,
		CharterComplete = 19,
		CollisionInvalid = 20,
		DbError = 21,
		DecorCannotBeRedeemed = 22,
		DecorItemNotDestroyable = 23,
		DecorNotFound = 24,
		DecorNotFoundInStorage = 25,
		DuplicateCharterSignature = 26,
		FilterRejected = 27,
		FixtureCantDeleteDoor = 28,
		FixtureHookEmpty = 29,
		FixtureHookOccupied = 30,
		FixtureHouseTypeMismatch = 31,
		FixtureNotFound = 32,
		FixtureSizeMismatch = 33,
		FixtureTypeMismatch = 34,
		GenericFailure = 35,
		GuildMoreAccountsNeeded = 36,
		GuildMoreActivePlayersNeeded = 37,
		GuildNotLoaded = 38,
		HouseEditLockFailed = 39,
		HouseExteriorAlreadyThatSize = 40,
		HouseExteriorAlreadyThatType = 41,
		HouseExteriorRootNotFound = 42,
		HouseExteriorTypeNeighborhoodMismatch = 43,
		HouseExteriorTypeNotFound = 44,
		HouseExteriorTypeSizeMismatch = 45,
		HouseExteriorSizeNotAvailable = 46,
		HookNotChildOfFixture = 47,
		HouseNotFound = 48,
		IncorrectFaction = 49,
		InvalidDecorItem = 50,
		InvalidDistance = 51,
		InvalidExteriorDocument = 52,
		InvalidGuild = 53,
		InvalidHouse = 54,
		InvalidInstance = 55,
		InvalidInteraction = 56,
		InvalidInteriorDocument = 57,
		InvalidLightOverlap = 58,
		InvalidMap = 59,
		InvalidNeighborhoodName = 60,
		InvalidRoomLayout = 61,
		InsufficientRoomBudget = 62,
		LockedByOtherPlayer = 63,
		LockOperationFailed = 64,
		MaxPlacedDecorReached = 65,
		MaxPetDecorReached = 66,
		MaxPreviewDecorReached = 67,
		MaxStorageDecorReached = 68,
		MissingCoreFixture = 69,
		MissingDye = 70,
		MissingExpansionAccess = 71,
		MissingFactionMap = 72,
		MissingPrivateNeighborhoodInvite = 73,
		MoreHouseSlotsNeeded = 74,
		MoreSignaturesNeeded = 75,
		NeighborhoodNotFound = 76,
		NoNeighborhoodOwnershipRequests = 77,
		NotInDecorEditMode = 78,
		NotInFixtureEditMode = 79,
		NotInLayoutEditMode = 80,
		NotInsideHouse = 81,
		NotOnOwnedPlot = 82,
		OperationAborted = 83,
		OwnerNotInGuild = 84,
		PermissionDenied = 85,
		PlacementTargetInvalid = 86,
		PlayerNotFound = 87,
		PlayerNotInInstance = 88,
		PlotNotFound = 89,
		PlotNotVacant = 90,
		PlotReservationCooldown = 91,
		PlotReserved = 92,
		RoomNotFound = 93,
		RoomPlacementOutOfBounds = 94,
		RoomUpdateFailed = 95,
		RpcFailure = 96,
		ServiceNotAvailable = 97,
		StaticDataNotFound = 98,
		TimeoutLimit = 99,
		TimerunningNotAllowed = 100,
		TokenRequired = 101,
		TooManyRequests = 102,
		TransactionFailure = 103,
		UncollectedExteriorFixture = 104,
		UncollectedHouseType = 105,
		UncollectedRoom = 106,
		UncollectedRoomMaterial = 107,
		UncollectedRoomTheme = 108,
		UnlockOperationFailed = 109,
	},
