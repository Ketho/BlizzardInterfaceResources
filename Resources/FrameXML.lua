local FrameXML = {
	...
	"ChatConfigVoiceSettings_OnShow",
	...
	"PlaySoundWhenEnteringChatWindowCheckButton_OnClick",
	"PlaySoundWhenEnteringChatWindowCheckButton_OnLoad",
	...
	"TextToSpeechFrameOkay_OnClick",
	"TextToSpeechFramePlaySampleButton_OnClick",
	"TextToSpeechFrameTtsVoiceDropdown_OnClick",
	"TextToSpeechFrameTtsVoiceDropdown_OnEvent",
