local FrameXML = {
	...
	"CollectionWardrobeUtil.PlayerCanCollectSource",
	...
	"CovenantUtil.GetRenownRewardDisplayData",
	"CovenantUtil.GetRenownRewardInfo",
	"CovenantUtil.GetUnformattedRenownRewardInfo",
	"CreateActorPool",
	"CreateAnchor",
	...
	"ItemUtil.GetOptionalReagentCount",
	...
	"PVPMatchUtil.SetupTableButtonColors",
	"PVPMatchUtil.UpdateMatchmakingText",
	"PVPMatchUtil.UpdateTable",
	...
	"UnitPopupSharedUtil.GetCurrentDropdownMenu",
...
local LoadOnDemand = {
	...
	"AuctionHouseUtil.AggregateSearchResults",
	...
	"AuctionHouseUtil.GetNotificationText",
	...
	"TradeSkillFrame_IsUsingDefaultFilters",
	"TradeSkillFrame_SetAllSourcesFiltered",
	"TradeSkillFrame_SetDefaultFilters",
	"TutorialStatus",
