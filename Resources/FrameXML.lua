local FrameXML = {
	...
	"OkayButton_OnClick",
	"OldRAFRewardsButton_OnClick",
	"OldRAFRewardsButton_OnEnter",
	"OldRAFRewardsButton_OnLoad",
	"OldRAFRewardsButton_Update",
	"OnExcessiveErrors",
	...
	"SetLargeTabardTexturesFromColorRGB",
	"SetMaxStackSize",
	"SetMoneyFrameColor",
