local FrameXML = {
	...
	"BattlefieldFrame_OnHide",
	"BattlefieldFrame_OnLoad",
	"BattlefieldFrame_OnShow",
	...
	"CommunitiesUtil.HasCommunityInvite",
	"CommunitiesUtil.IsInCommunity",
...
local LoadOnDemand = {
	...
	"CraftFrameFilterDropDown_Initialize",
	"CraftFrameFilterDropDown_LoadInvSlots",
	"CraftFrameFilterDropDown_OnClick",
