local FrameXML = {
	...
	"EncounterTimelineUtil.CreateInterpolator",
	"EncounterTimelineUtil.CreateOrientation",
	"EncounterTimelineUtil.GetEventIndicatorIconMask",
	"EncounterTimelineUtil.GetEventInfoList",
	...
	"EncounterWarningsUtil.GetTextColorForSeverity",
