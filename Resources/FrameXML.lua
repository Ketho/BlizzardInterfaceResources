local FrameXML = {
	...
	"PVPMatchUtil.GetOptionalCategories",
	...
	"TextToSpeechFrame_GetChannelEnabled",
	...
	"VoiceTranscription_DetermineChatType",
...
local LoadOnDemand = {
	...
	"ItemUpgradeFrame_GetNumUpgradeLevelsSelected",
	...
	"ItemUpgradeFrame_UpdateUpgradeOptions",
