local CVars = {
	var = {
		...
		["ColorNameplateNameBySelection"] = {"0", 4, false, true, "Color the unit names above nameplates based on the unit."},
		["combatLogRetentionTime"] = {"300", 4, true, false, "The maximum duration in seconds to retain combat log entries"},
		["combatLogUniqueFilename"] = {"0", 4, false, false, "Write combat log file with a timestamped name per client launch"},
		...
		["expandUpgradePanel"] = {"1", 5, false, false, "Controls whether the upgrade panel is expanded or collapsed."},
		...
		["graphicsEnvironmentDetail"] = {"3", 1, false, false, "UI value of the graphics setting"},
		...
		["graphicsTextureFiltering"] = {"3", 1, false, false, "UI value of the graphics setting"},
		...
		["heardChoiceSFX"] = {"0", 4, false, false, "Whether or not the user has heard the special SFX for the first transition choice selection."},
		...
		["nameplateCommentatorMaxDistance"] = {"1000", 1, false, true, "The max distance to show nameplates when in Commentator Mode."},
		...
		["raidGraphicsEnvironmentDetail"] = {"3", 1, false, false, "UI value of the raidGraphics setting"},
		...
		["raidGraphicsTextureFiltering"] = {"3", 1, false, false, "UI value of the raidGraphics setting"},
		...
		["RAIDtextureFilteringMode"] = {"2", 1, false, false, "Texture filtering mode"},
		...
		["rawMouseValidationMultiplier"] = {"5", 4, false, false, "When rawMouseEnable=0, limit mouse movements to a multiplier times raw mouse deltas to prevent the camera from snapping occasionally. (0 = no limit.)"},
		...
		["screenEdgeFlash"] = {"0", 4, true, false, "Whether to show a red flash while you are in combat with the world map up"},
		...
		["seenTBCInfoPane"] = {"0", 5, false, false, ""},
		...
		["showKeyring"] = {"0", 4, true, false, "Show the keyring button"},
		...
		["showUnactivatedCharacters"] = {"1", 4, false, false, "Show unactivated characters on Character Select."},
		...
		["Sound_EnableErrorSpeech"] = {"1", 5, false, false, "error speech"},
		["Sound_EnableMixMode2"] = {"0", 7, false, false, "test"},
		["Sound_EnableMusic"] = {"1", 5, false, false, "Enables music"},
		...
		["spellClutterRangeConstant"] = {"30.000000", 5, false, false, "The number of yards before the priority is doubled (min 1.0)"},
		...
		["textureFilteringMode"] = {"2", 1, false, false, "Texture filtering mode"},
