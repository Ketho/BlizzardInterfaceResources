local CVars = {
	var = {
		...
		["GamePadFaceMovementThreshold"] = {"180", 5, false, false, "Angle threshold for facing movement direction. 0 = always, 180 = never (115 allows using strafe with quick turn around)"},
		["GamePadForceXInput"] = {"0", 5, false, false, "Force game to use XInput, rather than a newer, more advanced api"},
		["GamePadSingleActiveID"] = {"0", 5, false, false, "ID of single GamePad device to use. 0 = Use all devices' combined input"},
		["GamePadSmoothFacing"] = {"0", 5, false, false, "Enable adjustment of facing direction to smooth out GamePad movement"},
		...
		["graphicsTextureFiltering"] = {"", 5, nil, nil, "UI value of the graphics setting"},
		...
		["gxApi"] = {"D3D11", 5, false, false, "graphics api"},
		...
		["GxPrismEnabled"] = {"1", 1, false, false, "Allow use of prism backend when possible"},
		...
		["heardChoiceSFX"] = {"0", 5, false, false, "Whether or not the user has heard the special SFX for the first transition choice selection."},
		...
		["Sound_SFXVolume"] = {"1.0", 5, false, false, "sound volume (0.0 to 1.0)"},
		...
		["spellClutterRangeConstantRaid"] = {"30.000000", 5, false, false, "The number of yards before the priority is doubled (min 1.0) in a raid"},
