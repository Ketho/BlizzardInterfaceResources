local CVars = {
	var = {
		...
		["contentTrackingFilter"] = {"1", 4, false, true, "If enabled, tracked items will display on the world map."},
		...
		["GxFrameEndMode"] = {"0", 1, false, false, "Allow GxFrameEnd to overlap next frame (feature not yet available)"},
		...
		["gxMTAlphaWater"] = {"1", 1, false, false, "Render Alpha Water Volumes in parallel."},
		...
		["gxMTParticulateVolumes"] = {"0", 1, false, false, "Render Particulate Volumes in parallel."},
		...
		["lastRenownForMajorFaction2564"] = {"0", 4, false, true, "Stores the Loamm Niffen renown when Renown UI is closed"},
		...
		["nameplatePlayerMaxDistance"] = {"60", 1, false, true, "The max distance to show player nameplates."},
		...
		["pvpFramesDisplayClassColor"] = {"0", 4, false, true, "Colors pvp frames with the class color"},
		["pvpFramesDisplayOnlyHealerPowerBars"] = {"0", 4, false, true, "Whether to display power bars only for healers on Pvp Frames"},
		["pvpFramesDisplayPowerBars"] = {"0", 4, false, true, "Whether to display mana, rage, etc. on Pvp Frames"},
		["pvpFramesHealthText"] = {"none", 4, false, true, "How to display health text on the pvp frames"},
		["pvpOptionDisplayPets"] = {"0", 4, false, true, "Whether to display pets on the pvp frames"},
		...
		["raidFramesDisplayOnlyHealerPowerBars"] = {"0", 4, false, true, "Whether to display power bars only for healers on Raid Frames"},
		...
		["ReplaceMyPlayerPortrait"] = {"0", 4, true, false, "Replaces local player's unit frame portrait with their class icon"},
		["ReplaceOtherPlayerPortraits"] = {"0", 4, true, false, "Replaces other player unit frame portraits with their class icon"},
		...
		["TargetAutoLock"] = {"0", 4, false, true, "Lock targets auto-set by the game"},
		...
		["useCompactPartyFrames"] = {"", 5, nil, nil, ""},
		...
		["wmoLodDistScale"] = {"1.0", 1, false, false, "Wmo level of detail distance scale"},
		["wmoPortalFadeScale"] = {"1000", 1, false, false, "Wmo portal fade scale"},
		["wmoPortalInteriorFade"] = {"0", 1, false, false, "Wmo portal interior fade"},
