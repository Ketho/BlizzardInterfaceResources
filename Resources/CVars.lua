local CVars = {
	var = {
		...
		["hardTrackedWorldQuests"] = {"", 4, nil, nil, "Internal cvar for saving user manually tracked world quests"},
		...
		["raidGraphicsSunshafts"] = {"1", 5, false, false, "UI value of the raidGraphics setting"},
		...
		["trackedWorldQuests"] = {"", 4, nil, nil, "Internal cvar for saving automatically tracked world quests"},
