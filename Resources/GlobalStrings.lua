...
AUCTION_CATEGORY_CONSUMABLES = "Consumable";
AUCTION_CATEGORY_CONTAINERS = "Container";
...
AUCTION_CATEGORY_PROJECTILE = "Projectile";
AUCTION_CATEGORY_QUEST_ITEMS = "Quest Items";
AUCTION_CATEGORY_QUIVER = "Quiver";
AUCTION_CATEGORY_REAGENT = "Reagent";
AUCTION_CATEGORY_RECIPES = "Recipe";
...
BACKPACK_AUTHENTICATOR_EXTRA_SLOTS_ADDED = "You gained 4 backpack slots for having an Authenticator attached to your account.";
...
BLIZZARD_GROUPS = "Blizzard Groups";
BLIZZARD_GROUPS_SHORT = "Groups";
BLIZZARD_STORE = "Shop";
...
BOOST2_WARLOCKAFF_DRAINLIFE = "Use |cFFFFFFFFDrain Soul|r.";
...
BOOST2_WARLOCKAFF_REMIND_DRAINLIFE = "Use |cFFFFFFFFDrain Soul|r.";
...
CHALLENGE_MODE_WEEKLY_REWARD_AVAILABLE = "You've earned a reward chest for last week's performance. Visit your Class Hall to claim it!";
...
CHARACTER_UPGRADE_CLASS_TRIAL_UNLOCK_READY_DESCRIPTION = "Apply Level 100 Character Boost to this character?";
...
CHAT_PLAYER_NOT_FOUND_NOTICE = "|Hchannel:%d|h[%s]|h Player %s is not on channel.";
CHAT_PLAYER_NOT_FOUND_NOTICE_BN = "|Hchannel:CHANNEL:%d|h[%s]|h Player %s is not on channel.";
...
CHAT_SET_VOICE_NOTICE = "|Hchannel:%d|h[%s]|h Voice given to %s.";
CHAT_SET_VOICE_NOTICE_BN = "|Hchannel:CHANNEL:%d|h[%s]|h Voice given to %s.";
...
CHAT_UNSET_VOICE_NOTICE = "|Hchannel:%d|h[%s]|h %s muted.";
CHAT_UNSET_VOICE_NOTICE_BN = "|Hchannel:CHANNEL:%d|h[%s]|h %s muted.";
...
COMBAT_TEXT_SHOW_ENERGIZE_TEXT = "Show Energy Gains";
...
COMMUNITIES_ADD_COMMUNITY = "Add Group";
...
COMMUNITIES_ADD_DIALOG_INVITE_LINK_DESCRIPTION = "Enter a group's invitation link or code:";
COMMUNITIES_ADD_DIALOG_INVITE_LINK_JOIN = "Join";
COMMUNITIES_ADD_DIALOG_INVITE_LINK_LABEL = "Join Blizzard Group";
COMMUNITIES_ADD_DIALOG_LABEL = "Add Group";
...
COMMUNITIES_CREATE_COMMUNITY = "Create Group";
...
COMMUNITIES_CREATE_DIALOG_DESCRIPTION_LABEL = "Group Description";
COMMUNITIES_CREATE_DIALOG_DESCRIPTION_LABEL_BATTLE_NET = "Group Description";
COMMUNITIES_CREATE_DIALOG_ICON_LABEL = "Group Icon Index";
...
COMMUNITIES_CREATE_DIALOG_NAME_INSTRUCTIONS = "The name of your group";
COMMUNITIES_CREATE_DIALOG_NAME_INSTRUCTIONS_BATTLE_NET = "The name of your group";
COMMUNITIES_CREATE_DIALOG_NAME_LABEL = "Group Name";
...
COMMUNITIES_CREATE_DIALOG_SHORT_NAME_INSTRUCTIONS_CHARACTER = "A shorter version of the group name";
...
COMMUNITIES_FRAME_TITLE = "Blizzard Groups";
...
COMMUNITIES_INVITE_MANAGER_LINK_INSTRUCTIONS = "Invite links are an easy way to invite multiple characters to a group. Just post a link in chat or paste it on the web to give quick access to joining this group. Links have a timeout and a limited use count, which you can change in Link Options.";
...
COMMUNITIES_JOIN_COMMUNITY = "Join or Create Group";
...
COMMUNITY_MEMBER_LIST_DROP_DOWN_REMOVE = "Remove from Group";
...
COMPACT_UNIT_FRAME_PROFILE_AUTOACTIVATE20PLAYERS = "20 Player Group";
...
CONFIRM_TALENT_WIPE_1 = "Do you want to unlearn all of your talents?  The cost will increase each time you do it.";
...
EJ_LOOT_SLOT_FILTER_ARTIFACT_RELIC = "Artifact Relic";
ELITE = "Elite";
...
ERROR_CLUB_ACTION_CREATE_COMMUNITY = "Couldn't create group. %s";
...
ERROR_CLUB_ACTION_DESTROY_COMMUNITY = "Couldn't destroy group. %s";
...
ERROR_CLUB_ACTION_EDIT_COMMUNITY = "Couldn't edit group. %s";
...
ERROR_CLUB_ACTION_LEAVE_COMMUNITY = "Couldn't leave group. %s";
...
ERROR_CLUB_ACTION_SUBSCRIBE_COMMUNITY = "Couldn't subscribe to group. %s";
...
ERROR_CLUB_BAN_COUNT_AT_MAX_COMMUNITY = "Can't ban any more players for this group.";
ERROR_CLUB_FULL = "The Blizzard group is full.";
ERROR_CLUB_FULL_COMMUNITY = "The group is full.";
...
ERROR_CLUB_NO_CLUB_COMMUNITY = "The group doesn't exist.";
...
ERROR_CLUB_SENT_INVITATION_COUNT_AT_MAX_COMMUNITY = "Can't send any more invitations for this group.";
...
ERROR_CLUB_TOO_MANY_CLUBS_JOINED_COMMUNITY = "Can't join any more groups.";
...
GARRISON_FOLLOWER_BELOW_ITEM_LEVEL_TOOLTIP = "This follower's item level is below this mission's item level. This follower will earn less XP and contribute less to success.";
GARRISON_FOLLOWER_BELOW_LEVEL_MAX_XP_TOOLTIP = "This follower's item level is below this mission's item level. This follower will contribute less to success.";
...
GUILD_CHALLENGE_TOOLTIP5 = "Complete any Legion dungeon after activating a Mythic Keystone while in a guild group.";
...
HELP_LABEL = "Help";
HELP_OPTIONS_MOVED = " Colorblind and Move Pad options have been moved to the Accessibility section.";
...
HONOR_TALENT_HONOR_LEVELS = "Earn Honor by participating in PvP. Reach higher Honor Levels to access new talents and rewards.";
...
HUNTER_PET_CUNNING_CORE_ABILITY_1 = "Ability that reduces all damage your pet takes for a short time, and removes impairing effects.";
HUNTER_PET_CUNNING_CORE_ABILITY_2 = "Ability that increases your pet's movement speed for a short time.";
...
HUNTER_PET_FEROCITY_CORE_ABILITY_1 = "Abiltiy that increases your pet's movement speed for a short time.";
HUNTER_PET_FEROCITY_CORE_ABILITY_2 = "Ability that instantly returns your dead pet to life.";
...
HUNTER_PET_TENACITY_CORE_ABILITY_1 = "Ability that causes your pet to move rapidly to the target's location.";
HUNTER_PET_TENACITY_CORE_ABILITY_2 = "Ability that increases your pet's health for a short time.";
...
INVITE_COMMUNITY_MEMBER_POPUP_SUGGEST_TEXT = "Suggest This Group";
...
ITEM_COOLDOWN_TIME_HOURS = "Cooldown remaining: %d |4hour:hrs;";
...
ITEM_ENCHANT_TIME_LEFT_HOURS = "%s (%d |4hour:hrs;)";
...
LEVEL_UP_HONOR_LINK = "|cffFF4E00|Hhonortalent:|h[Honor Talents]|h|r Available!";
...
LOGOUT = "Logout";
LOG_PERIODIC_EFFECTS_TEXT = "Periodic Damage";
LOOKING = "Looking";
...
LOOT_ROLL_PASSED_AUTO = "|HlootHistory:%d|h[Loot]|h: %s automatically passed on: %s because he cannot loot that item.";
LOOT_ROLL_PASSED_AUTO_FEMALE = "|HlootHistory:%d|h[Loot]|h: %s automatically passed on: %s because she cannot loot that item.";
...
LOOT_ROLL_WON_NO_SPAM_GREED = "|HlootHistory:%d|h[Loot]|h: %s won: %s |cff818181(Greed - %d)|r";
LOOT_ROLL_WON_NO_SPAM_NEED = "|HlootHistory:%d|h[Loot]|h: %s won: %s |cff818181(Need - %d)|r";
...
LOOT_ROLL_YOU_WON_NO_SPAM_GREED = "|HlootHistory:%d|h[Loot]|h: You won: %s |cff818181(Greed - %d)|r";
LOOT_ROLL_YOU_WON_NO_SPAM_NEED = "|HlootHistory:%d|h[Loot]|h: You won: %s |cff818181(Need - %d)|r";
...
NEWBIE_TOOLTIP_BLIZZARDGROUPSTAB = "Allows you to communicate with friends across Blizzard games and manage your Blizzard Groups.";
...
NPC_NAMES_DROPDOWN_HOSTILE = "Hostile NPCs";
NPC_NAMES_DROPDOWN_HOSTILE_TOOLTIP = "Display names for hostile NPC's.";
NPC_NAMES_DROPDOWN_INTERACTIVE = "Hostile and Interactive NPCs";
NPC_NAMES_DROPDOWN_INTERACTIVE_TOOLTIP = "Display names for hostile NPC's and NPC's you can interact with.";
...
PLAYER_V_PLAYER_SEASON = "Player vs. Player (Legion Season %d)";
...
POWER_GAINS_COMBATLOG_TOOLTIP = "Show messages when a spell or ability restores mana, energy, rage, focus, or pet happiness.";
...
PRIEST_SHADOW_CORE_ABILITY_5 = "Strong attack that damages your enemies and activates Voidform. Requires 100 Insanity.";
...
PVP_PRESTIGE_RANK_UP_NEXT_MAX_LEVEL_REWARD = "Next Honor Level %d Reward";
PVP_PRESTIGE_RANK_UP_TITLE = "Prestige";
PVP_PRESTIGE_RANK_UP_WARNING = "Your Honor Level will be reset to 1 but you will keep all of your Honor Talents.";
...
ROGUE_SUB_CORE_ABILITY_1 = "Attack that requires Stealth and generates 1 Combo Point. Teleports you behind your target when used while out of combat.";
...
SELF_HIGHLIGHT_IN_BG = "Show In Battlegrounds";
SELF_HIGHLIGHT_IN_BG_COMBAT = "Only In Combat";
SELF_HIGHLIGHT_IN_RAID = "Show In Raids";
SELF_HIGHLIGHT_IN_RAID_COMBAT = "Only In Combat";
...
SHOW_DAMAGE_TEXT_TEXT = "Show Target Damage";
...
SHOW_PET_MELEE_DAMAGE_TEXT = "Pet Damage";
...
SPELL_FAILED_GARRISON_FOLLOWER_MIN_ITEM_LEVEL = "That follower's item level is too low for the power of this spell.";
...
TOOLTIP_HONOR_POINTS = "Honor is gained by killing members of the opposite faction in PvP combat and completing PvP objectives. Honor increases your Honor Level to unlock Honor Talents.";
...
UNIT_LOYALTY_COMBATLOG_TOOLTIP = "Show messages when you pet's loyalty changes";
