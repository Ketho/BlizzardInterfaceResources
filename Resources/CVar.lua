CVar = {
	variable = {
		...
		["BrowserNavigateLog"] = {"0", 0, false, false, "Enables Logging of browser navigation requests (Requires /reload)"},
		...
		["lastCharacterIndex"] = {"0", 5, false, false, ""},
		...
		["twitterGetConfigTime"] = {"0", 5, false, false, ""},
