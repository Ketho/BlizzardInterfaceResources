CVar = {
	variable = {
		...
		["clubFinderCacheExpiry"] = {"300000", 4, false, false, "Value in (MS) for time to expire the cache."},
		["clubFinderCachePendingExpiry"] = {"300000", 4, false, false, "Value in (MS) for time to expire the cache."},
		...
		["enableMemoryTrap"] = {"1", 0, false, false, "Whether memory access trapping is enabled.  Disabling may slightly improve performance, but at the cost of less information when memory access violations occur."},
		...
		["fstack_preferParentKeys"] = {"1", 0, false, false, "0: Prefer Global Names, 1: Prefer ParentKeys (Default)."},
		...
		["GxAllowSoftwareRenderer"] = {"", 1, false, false, "Allow software renderer to be chosen. Warning: the software renderer is very slow"},
		...
		["gxMTOpaque"] = {"1", 1, false, false, "Render opaque pass in parallel."},
		...
		["worldViewCullMaxJobs"] = {"6", 1, false, false, "Maximum job threads for culling"},
